Collaborative Notepad A real-time collaborative notepad where multiple users can edit the same document simultaneously. Changes made by one user will be instantly visible to all others.
